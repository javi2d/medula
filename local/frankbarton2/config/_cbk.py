...
#@brain.Lib.callbacks.Root.knobChanged
def beforeScriptLoad():
	...
	if cond1 or cond2:
		...
		script_path = sop.Normalize.path( this.VALUE )
...
brain.Lib.include.CALLBACK( 'Root/beforeScriptLoad' , beforeScriptLoad , 'Root' , 'knobChanged'  )
