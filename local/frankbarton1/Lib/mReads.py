...
def getClipname( default = None ): #, this = space.this  
	...
	for value in clip_names:
		...
		if os.path.isdir( value ):
			...
			brain.Lib.sequence.recursive_read_creator( value  )
			...
			brain.Lib.sequence.recursive_read_creator( dirname , pattern = basename )
			...
			brain.Lib.sequence.read_creator( seq_path , ff , lf )
